...
const ArticleListRow: React.FC<ArticleListRowProps> = ({ item, onViewArticle, pageTitle, onDownload }) => {
    ...
    return (
        <button
            ...
            className="w-full text-left bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col sm:flex-row overflow-hidden group"
        >
