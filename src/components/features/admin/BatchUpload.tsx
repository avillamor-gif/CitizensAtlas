...
const BatchUpload: React.FC<BatchUploadProps> = ({ onSuccess, projects = [] }) => {
    ...
    const handleDownloadTemplateWithData = () => {
        ...
        const headers = [
            ...
            'False Solution - Waste-to-Energy Incineration (X/Yes)',
            'False Solution - Medical Incineration (X/Yes)',
            'False Solution - Plastic-to-Fuel Technologies (X/Yes)',
            'False Solution - Plastic Recycling (X/Yes)',
            'False Solution - Refuse-Derived Plastics (X/Yes)',
            'False Solution - Plastic-to-Roads (X/Yes)',
            'False Solution - Plastic Credit Schemes (X/Yes)',
            'False Solution - Bioplastics (X/Yes)',
            'False Solution - Plastic to Nuclear Energy (X/Yes)',
            'False Solution - Chemical Recycling (X/Yes)',
            'False Solution - Carbon Capture on Landfill (X/Yes)',
            'False Solution - Refuse-derived fuel (X/Yes)',
            'False Solution - Carbon Credits (X/Yes)',
            'Project Description',
            'Approval Date*',
            'Start Date',
            'End Date',
            ...
            'IFI - Others (X/Yes)',
            'Other IFI',
            'Funding Source (IFI | Instrument | Amount M USD)',
            'Financial Instruments',
            'Total Project Amount (M USD)',
        ...
        const rows = projects.map((project) => [
            ...
            project.corruptionType.includes('Waste-to-Energy Incineration') ? 'x' : '',
            project.corruptionType.includes('Medical Incineration') ? 'x' : '',
            project.corruptionType.includes('Plastic-to-Fuel') ? 'x' : '',
            project.corruptionType.includes('Plastic Recycling') ? 'x' : '',
            project.corruptionType.includes('Refuse-Derived Plastics') ? 'x' : '',
            project.corruptionType.includes('Plastic-to-Roads') ? 'x' : '',
            project.corruptionType.includes('Plastic Credit') ? 'x' : '',
            project.corruptionType.includes('Bioplastics') ? 'x' : '',
            project.corruptionType.includes('Plastic to Nuclear') ? 'x' : '',
            project.corruptionType.includes('Chemical Recycling') ? 'x' : '',
            project.corruptionType.includes('Carbon Capture on Landfill') ? 'x' : '',
            project.corruptionType.includes('Refuse-derived fuel') ? 'x' : '',
            project.corruptionType.includes('Carbon Credits') ? 'x' : '',
